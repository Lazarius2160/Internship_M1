...
// WIDGET HAD AN IMPACT. BOTH APPEAR WELL ON THE SCREEN WITH ONE IN STEREO AND NOT THE OTHER
...
int main(int argc, char** argv)
{
  ...
  // marine, test sans stereo widget mais marche pas:  
  QSurfaceFormat::setDefaultFormat(QVTKOpenGLNativeWidget::defaultFormat(1));
  //on place l'autre surface plus bas pour les tests

  QVTKOpenGLStereoWidget widget;
  QVTKOpenGLNativeWidget widgetNative;
  // pas utile si passe par stereo widget meme en ++ lignes commande : widget.defaultFormat(1);
