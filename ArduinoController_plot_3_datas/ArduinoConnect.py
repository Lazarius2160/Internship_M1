...
class ArduinoPlotter():
  ...
  global i 
  i = 0 #----------------------marine, variable pour alterner x y et z 
  ...
  def __init__(self, numberOfSamples):
    ...
    # _________________create plot node: tableau ? voir example___________________ 
    # Create plot node for X 
    self.plotSeriesNode = slicer.mrmlScene.AddNewNodeByClass("vtkMRMLPlotSeriesNode", "X") 
    self.plotSeriesNode.SetAndObserveTableNodeID(self.tableNode.GetID()) 
    self.plotSeriesNode.SetXColumnName("a") 
    self.plotSeriesNode.SetYColumnName("x") 
    ...
    # Create plot node for Y
    self.plotSeriesNode2 = slicer.mrmlScene.AddNewNodeByClass("vtkMRMLPlotSeriesNode", "Y") 
    self.plotSeriesNode2.SetAndObserveTableNodeID(self.tableNode.GetID()) 
    self.plotSeriesNode2.SetXColumnName("a") 
    self.plotSeriesNode2.SetYColumnName("y") 
    self.plotSeriesNode2.SetPlotType(slicer.vtkMRMLPlotSeriesNode.PlotTypeLine) 
    self.plotSeriesNode2.SetLineStyle(slicer.vtkMRMLPlotSeriesNode.LineStyleSolid) 
    self.plotSeriesNode2.SetMarkerStyle(slicer.vtkMRMLPlotSeriesNode.MarkerStyleSquare) 
    self.plotSeriesNode2.SetUniqueColor()   

    # Create plot node for Z 
    self.plotSeriesNode3 = slicer.mrmlScene.AddNewNodeByClass("vtkMRMLPlotSeriesNode", "Z") 
    self.plotSeriesNode3.SetAndObserveTableNodeID(self.tableNode.GetID()) 
    self.plotSeriesNode3.SetXColumnName("a") 
    self.plotSeriesNode3.SetYColumnName("z")
    self.plotSeriesNode3.SetPlotType(slicer.vtkMRMLPlotSeriesNode.PlotTypeLine) 
    self.plotSeriesNode3.SetLineStyle(slicer.vtkMRMLPlotSeriesNode.LineStyleSolid) 
    self.plotSeriesNode3.SetMarkerStyle(slicer.vtkMRMLPlotSeriesNode.MarkerStyleSquare) 
    self.plotSeriesNode3.SetUniqueColor()
    ...
    self.plotChartNode.AddAndObservePlotSeriesNodeID(self.plotSeriesNode2.GetID()) 
    self.plotChartNode.AddAndObservePlotSeriesNodeID(self.plotSeriesNode3.GetID()) 
  ...
  def initializeTable(self):
    ...
    self.arrZ.SetName("z")
    self.table.AddColumn(arrZ)

    self.arrA = vtk.vtkFloatArray() # amplitude
    self.arrA.SetName("a")
    self.table.AddColumn(arrA)

    #self.table.SetNumberOfRows(3)
    #for i in range(self.numberOfSamples):
    #    self.table.SetValue(i, 0, i)
    #    self.table.SetValue(i, 1, )
    #    self.table.SetValue(i, 2, 0)
    #    self.table.SetValue(i, 3, 0)

    self.table.SetNumberOfRows(self.numberOfSamples)  #______________number of samples = nombre de points aue tu vas afficher sur le plot
    for i in range(self.numberOfSamples):
        self.table.SetValue(i, 0, i)
  ...
  def addPointToPlot(self, caller, event):
    ...
    global i #------------------re dis quel i on parle 
    ...
    if self.active:
      ...
      if i==0 :
          print("Data X :")
          print(self.ArduinoNode.GetParameter("Data"))

          self.arrX.InsertNextTuple1(messageFloat)
          ...
          self.arrZ.InsertNextTuple1(messageFloat)
          self.arrZ.RemoveFirstTuple()
          i = 0
          print(i)
